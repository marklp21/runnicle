        ...
        <div className="max-w-2xl mx-auto text-center py-16 space-y-8 animate-fade-in">
          ...
          <div>
            ...
            <p className="mt-3 text-zinc-400 text-sm max-w-md mx-auto leading-relaxed font-semibold">
              Your coaching session with <span className="text-white font-bold">{selectedCoach}</span> has been confirmed.
            </p>
          </div>

          {/* Details Dashboard Card */}
          <div className="rounded-xl border border-zinc-800 bg-[#0d0d0d] p-6 text-left max-w-md mx-auto space-y-4">
            <div className="flex justify-between items-center border-b border-zinc-900 pb-3 text-xs font-semibold">
              <span className="text-zinc-500">Coach Partner</span>
              <span className="text-white font-bold">{selectedCoach}</span>
            </div>
          ...
          <button
            onClick={onBack}
            className="rounded-md bg-white px-8 py-3 text-xs font-bold text-black hover:bg-zinc-200 transition-colors uppercase tracking-wider cursor-pointer"
          >
            Return to Portal
          </button>
        ...
        <div className="space-y-8">
          ...
          <div className="border-b border-zinc-900 pb-5">
            ...
            <p className="mt-2 text-sm text-zinc-500 font-medium">
              Schedule a 30-minute introductory strategic session with <span className="text-zinc-300 font-bold">{selectedCoach}</span> to analyze your potential.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="font-display text-base font-black text-white uppercase tracking-wider border-b border-zinc-900 pb-2">1. Select Date & Time</h3>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-extrabold text-white uppercase tracking-wider mb-2">Consultation Date</label>
                    <input
                      type="date"
                      required
                      value={bookingDate}
                  ...
                  <div>
                    <label className="block text-[10px] font-extrabold text-white uppercase tracking-wider mb-2">Available Time slots</label>
                    <select
                      required
                      value={bookingTime}
              ...
              <div className="space-y-4 pt-4">
                <h3 className="font-display text-base font-black text-white uppercase tracking-wider border-b border-zinc-900 pb-2">2. Running Background</h3>
                
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    <label className="block text-[10px] font-extrabold text-white uppercase tracking-wider mb-2">Current Weekly Mileage</label>
                    <select
                      value={mileage}
                  ...
                  <div>
                    <label className="block text-[10px] font-extrabold text-white uppercase tracking-wider mb-2">Running Goals & Concerns</label>
                    <textarea
                      required
                      rows={4}
                      value={goals}
                      ...
                      className="w-full rounded border border-zinc-800 bg-[#0c0c0c] px-4 py-3.5 text-xs text-white placeholder-zinc-700 focus:border-white focus:outline-none resize-none"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-[#0c0c0c] p-6 shadow-2xl space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-white">
                    <BookOpen className="h-5 w-5" />
                  </div>
                  <div>
                    <span className="text-xs font-bold text-white block">30-Min Strategic Video Call</span>
                    <span className="text-[10px] text-zinc-500 font-medium block">Personalized, 1-on-1 advice</span>
                  </div>
                </div>

                <div className="text-xs font-semibold text-zinc-400 space-y-2 pt-2 leading-relaxed">
