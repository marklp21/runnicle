      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
        ...
        <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="font-sans text-base font-bold text-zinc-900 uppercase tracking-wider border-b border-zinc-200 pb-2">1. Delivery Address</h3>
            ...
            <div>
              <label className="block text-[10px] font-extrabold text-zinc-700 uppercase tracking-wider mb-2">Street Address</label>
              <input
                type="text"
                name="address"
                required
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-extrabold text-zinc-700 uppercase tracking-wider mb-2">City</label>
                <input
                  type="text"
                  name="city"
                  required
              ...
              <div>
                <label className="block text-[10px] font-extrabold text-zinc-700 uppercase tracking-wider mb-2">Zip/Postal Code</label>
                <input
                  type="text"
                  name="zipCode"
                  required
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-center justify-between border-b border-zinc-200 pb-2">
              <h3 className="font-sans text-base font-bold text-zinc-900 uppercase tracking-wider">2. Credit Card Details</h3>
            ...
            <div>
              <label className="block text-[10px] font-extrabold text-zinc-700 uppercase tracking-wider mb-2">Card Number</label>
              <input
                type="text"
                name="cardNumber"
                required
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-extrabold text-zinc-700 uppercase tracking-wider mb-2">Expiry Date</label>
                <input
                  type="text"
                  name="cardExpiry"
                  required
              ...
              <div>
                <label className="block text-[10px] font-extrabold text-zinc-700 uppercase tracking-wider mb-2">Security Code (CVV)</label>
                <input
                  type="text"
                  name="cardCvv"
                  required
            ...
            {cartItems.map((item, idx) => (
              <div key={idx} className="flex justify-between items-center text-xs">
                <div>
                 ...
                 <span className="text-zinc-900 font-bold font-mono">₱{(item.product.price * item.quantity).toLocaleString()}</span>
              </div>
            ))}
          </div>
