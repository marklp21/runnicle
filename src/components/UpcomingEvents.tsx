      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-10">
          ...
          <button
            ...
            className="mt-4 sm:mt-0 inline-flex items-center text-xs font-bold tracking-wider text-zinc-700 hover:text-orange-500 transition-colors uppercase gap-1.5 cursor-pointer group"
          >
            View All
            ...
            >
              ...
              <div className="flex-1 p-5 flex flex-col justify-between">
                <div>
                  ...
                  {}
                  <h3 className="font-sans text-base font-bold text-zinc-900 mb-3 group-hover:text-brand transition-colors">
                    {event.title}
                  </h3>
